...
def train_random_forest(datasets_dir, training_dir, protein_model, substrate_model, model_name):
    ...
    with open(join(model_save_path, f"RandomForest_model_{training_dir}.pkl"), "wb") as file:
...
def main():
    ...
    train_random_forest(datasets_dir, training_dir, protein_model, substrate_model, model_name)
