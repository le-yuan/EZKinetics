...
def train_xgboost(datasets_dir, training_dir, protein_model, substrate_model, model_name):
    ...
    # model = XGBRegressor(objective='reg:pseudohubererror', random_state=42)
    ...
    # model = XGBRegressor(objective='reg:pseudohubererror', **best_params)
    ...
    with open(join(model_save_path, f"XGBoost_model_{training_dir}.pkl"), "wb") as file:
...
def main():
    ...
    train_xgboost(datasets_dir, training_dir, protein_model, substrate_model, model_name)
