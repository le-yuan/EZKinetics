...
SMILES_BERT = "DeepChem/ChemBERTa-77M-MLM"
...
def create_smiles_embeddings_ChemBERTa_MLM(unique_smiles, out_path, smiles_embed_no) :
    if not os.path.exists(join(out_path, "SMILES", "ChemBERTa-77M-MLM")) :
        os.makedirs(join(out_path, "SMILES", "ChemBERTa-77M-MLM"), exist_ok=True)
    ...
    for part in range(parts) :
        ...
        with open(join(out_path, "SMILES", "ChemBERTa-77M-MLM", "SMILES_repr_"+str(part+1)+".pkl"), "wb") as outfile :
